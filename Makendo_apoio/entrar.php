...
<form class="cd-form floating-labels" method="post" action="" onSubmit="Localizar()"><br>
  <h2>Entrar</h2>
  <?php
  ...
  ?>
  <br>
  <h4><i class="material-icons">person</i>Usuário</h4><input class="usuario" type="text" value="" name="cd-usuario" id="cd-usuario" required><br>
  <h4><i class="material-icons">lock</i>Senha</h4><input class="senha" type="password" value="" name="cd-senha" id="cd-senha" required><br><input type="submit" value="Entrar">
</form>
<?php
unset($padrao);
?>